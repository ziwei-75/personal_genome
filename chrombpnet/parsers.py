...
def read_parser():
	...
	def general_training_args(required_train, optional_train):
		...
		required_train.add_argument("-sl", "--sample-list", type=str,  required=True,  default="None", help="sample list")
		...
		# group.add_argument('-ibw', '--input-bigwig-file', type=str, help="Input bigWig file")
